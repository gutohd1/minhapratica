 ...
 <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url ('') }}">Minha Pratica IT</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li {{ (Request::is('*provincia.list') ? 'class="active"' : '') }}>
                            <a href="{{ route("provincia.list") }}">Provincias e Comunes</a>
                        </li>
                        <li {{ (Request::is('*cliente.list') ? 'class="active"' : '') }}>
                            <a href="{{ route("cliente.list") }}">Clientes</a>
                        </li>
                        <li {{ (Request::is('*busca.list') ? 'class="active"' : '') }}>
                            <a href="{{ route("busca.list") }}">Buscas</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
